...
class AppGeneralDetailFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAppDetailGeneralBinding

    private lateinit var viewModel: AppGeneralDetailsFragmentViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentAppDetailGeneralBinding.inflate(inflater, container, false)
