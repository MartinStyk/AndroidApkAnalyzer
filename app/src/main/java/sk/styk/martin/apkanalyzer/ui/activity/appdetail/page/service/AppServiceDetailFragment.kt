...
import sk.styk.martin.apkanalyzer.databinding.FragmentAppDetailServiceBinding
...
class AppServiceDetailFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAppDetailServiceBinding

    private lateinit var viewModel: AppServiceDetailFragmentViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentAppDetailServiceBinding.inflate(inflater, container, false)
