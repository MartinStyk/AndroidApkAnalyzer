...
import sk.styk.martin.apkanalyzer.ui.adapter.detaillist.ProviderListAdapter
...
class AppDetailFragment_Provider : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        val data = arguments.getParcelableArrayList<ContentProviderData>(AppDetailPagerFragment.ARG_CHILD)
