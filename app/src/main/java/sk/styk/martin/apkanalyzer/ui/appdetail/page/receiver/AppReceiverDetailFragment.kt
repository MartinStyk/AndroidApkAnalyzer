...
@AndroidEntryPoint
class AppReceiverDetailFragment : AppDetailPageFragment<AppReceiverDetailFragmentViewModel, FragmentAppDetailPageBinding>() {

    @Inject
    lateinit var viewModelFactory: AppReceiverDetailFragmentViewModel.Factory

    override fun createViewModel(): AppReceiverDetailFragmentViewModel {
