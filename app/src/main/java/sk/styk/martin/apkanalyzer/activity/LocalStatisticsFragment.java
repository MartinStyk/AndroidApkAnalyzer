...
public class LocalStatisticsFragment extends Fragment implements LoaderManager.LoaderCallbacks<LocalStatisticsData>, LocalStatisticsLoader.ProgressCallback {
    ...
    public void onLoadFinished(Loader<LocalStatisticsData> loader, LocalStatisticsData data) {
        ...
        binding.itemAnalyzeSuccess.setValueText(data.getAnalyzeSuccess().getCount().toString() + "  (" + BigDecimalFormatter.INSTANCE.getCommonFormat().format(data.getAnalyzeSuccess().getPercentage()) + "%)");
        binding.itemAnalyzeFailed.setValueText(data.getAnalyzeFailed().getCount().toString() + "  (" + BigDecimalFormatter.INSTANCE.getCommonFormat().format(data.getAnalyzeFailed().getPercentage()) + "%)");
        binding.itemSystemApps.setValueText(data.getSystemApps().getCount().toString() + "  (" + BigDecimalFormatter.INSTANCE.getCommonFormat().format(data.getSystemApps().getPercentage()) + "%)");
