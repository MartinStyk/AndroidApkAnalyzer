...
import sk.styk.martin.apkanalyzer.databinding.FragmentAppDetailProviderBinding
...
class AppProviderDetailFragment : Fragment() {
    ...
    private lateinit var binding: FragmentAppDetailProviderBinding

    private lateinit var viewModel: AppProviderDetailFragmentViewModel
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentAppDetailProviderBinding.inflate(inflater, container, false)
