...
import sk.styk.martin.apkanalyzer.ui.activity.appdetail.page.provider.AppReceiverDetailListAdapter
...
class AppReceiverDetailFragmentViewModel @AssistedInject constructor(
        ...
        val adapter: AppReceiverDetailListAdapter,
    ...
    private val appDetailsObserver = Observer<AppDetailData> {
        adapter.items = it.broadcastReceiverData
    }
