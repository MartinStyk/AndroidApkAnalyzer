...
inline fun <reified VM : ViewModel> ComponentActivity.provideViewModel(crossinline block: () -> VM): VM {
    return ViewModelProvider(
        this,
        object : ViewModelProvider.Factory {
            override fun <A : ViewModel> create(modelClass: Class<A>): A {
...
inline fun <reified VM : ViewModel> ComponentActivity.provideViewModel(viewModelFactory: ViewModelProvider.Factory? = null): VM {
    viewModelFactory?.let {
        return ViewModelProvider(this, it)[VM::class.java]
    }
    return ViewModelProvider(this)[VM::class.java]
